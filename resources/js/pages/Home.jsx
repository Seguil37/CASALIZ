            ...
            <section className="hero container">
                <div>
                    ...
                    <p className="hero-subtitle">
                        CASALIZ E.I.R.L. diseña, documenta y supervisa proyectos residenciales, corporativos y públicos con una
                        mirada integral: estética, normativa y ejecución alineadas.
                    </p>
            ...
            <section className="container">
                <div className="section-header">
                    ...
                    <p className="section-subtitle">
                        Documentos listos para licitar, tramitar y ejecutar sin fricciones.
                    </p>
                </div>
