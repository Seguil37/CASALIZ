    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          rows="8"
          className="w-full px-4 py-3 border-2 border-[#9a98a0] rounded-xl focus:border-primary focus:outline-none resize-y font-mono text-sm"
      ...
      <div>
        ...
        <textarea
          ...
          onChange={handleChange}
          rows="6"
          className="w-full px-4 py-3 border-2 border-[#9a98a0] rounded-xl focus:border-primary focus:outline-none resize-y"
