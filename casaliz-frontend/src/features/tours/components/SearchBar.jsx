      ...
      <div className="bg-[#f8f5ef] rounded-2xl shadow-lg p-2 md:p-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          <div className="relative">
            <label className="block text-xs font-semibold text-[#233274] mb-1.5">Palabra clave</label>
            <div className="relative">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[#e15f0b] w-4 h-4" />
              <input
                type="text"
                placeholder="Nombre de proyecto o cliente"
