    ...
    <div className="min-h-screen bg-[#f8f5ef] py-10">
      <div className="container-custom space-y-6">
        ...
        <div className="bg-white/70 rounded-2xl shadow-lg border border-[#ebe7df]">
          ...
          <div className="flex flex-col gap-3 p-5 border-b border-[#ebe7df] md:flex-row md:items-center md:justify-between">
            <label className="relative block w-full md:max-w-md">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#d8d1c6] bg-white py-3 pl-12 pr-4 text-[#233274] outline-none transition-colors placeholder:text-[#9a98a0] focus:border-[#233274]"
              />
            </label>
          ...
          <div className="flex flex-wrap gap-3 px-5 py-3 border-b border-[#ebe7df] text-xs font-semibold text-[#6c6b70]">
            <span className="inline-flex items-center gap-1">
              <UserCog className="h-4 w-4 text-[#233274]" /> Editar
            </span>
            <span className="inline-flex items-center gap-1">
                ...
                <tbody className="divide-y divide-[#f1ece2]">
                  {users.map((u) => (
                    <tr key={u.id} className="hover:bg-[#fdfaf5]">
                      ...
                      <td className="py-4 px-4 text-[#233274] break-all">{u.email}</td>
                      <td className="py-4 px-4">
                        <span
                      ...
                      <td className="py-4 px-4 text-[#6c6b70]">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex flex-wrap gap-2">
                          <button
                            ...
                            className="inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg border border-[#ebe7df] text-[#233274] hover:bg-[#f8f5ef]"
                          >
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-2xl border border-[#ebe7df] bg-white/80 p-5 shadow-lg">
              ...
              <div>
                ...
                <p className="mt-2 max-w-3xl text-sm leading-6 text-[#6c6b70]">
      ...
      {selectedPermissionUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6">
          <div className="w-full max-w-3xl rounded-2xl bg-white shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex flex-col gap-3 border-b border-[#ebe7df] p-6 md:flex-row md:items-start md:justify-between">
              <div>
                <p className="text-sm uppercase tracking-[0.2em] text-[#e15f0b] font-semibold">Permisos individuales</p>
                <h3 className="mt-2 text-2xl font-black text-[#233274]">{selectedPermissionUser.name}</h3>
                <p className="mt-1 text-sm text-[#6c6b70]">
              ...
              <button
                ...
                className="rounded-lg border border-[#ebe7df] px-4 py-2 text-sm font-bold text-[#233274] hover:bg-[#f8f5ef]"
              >
                Cerrar
              </button>
            </div>

            <div className="divide-y divide-[#f1ece2] p-2">
              {moduleOrder.map((moduleKey) => {
                const moduleMeta = permissionModules[moduleKey] || {};
...
const Pagination = ({ meta, onPageChange }) => {
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-[#ebe7df] p-5 text-sm text-[#6c6b70] md:flex-row md:items-center md:justify-between">
      <div>
        Mostrando <span className="font-bold text-[#233274]">{meta.from || 0}</span>
        {' - '}
        <span className="font-bold text-[#233274]">{meta.to || 0}</span>
        {' de '}
        <span className="font-bold text-[#233274]">{meta.total || 0}</span>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-[#ebe7df] hover:bg-[#f8f5ef] disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        {pages.map((page, index) => {
          ...
          return (
            <div key={page} className="flex items-center gap-2">
              {showGap && <span className="text-[#9a98a0]">...</span>}
              <button
                type="button"
